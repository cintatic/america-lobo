<template>
  <div>
    ...
    <p>
      El presente Política de Privacidad establece los términos en que America
      Lobo usa y protege la información que es proporcionada por sus usuarios al
    ...
    <p>
      America Lobo está altamente comprometido para cumplir con el compromiso de
    ...
    <p>
      ...
      automáticamente pues sirve para tener un mejor servicio web. También usted
      puede cambiar la configuración de su ordenador para declinar las cookies.
    ...
    <p>
      America Lobo Se reserva el derecho de cambiar los términos de la presente
